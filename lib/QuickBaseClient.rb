...
# See the testQuickBaseClient() method at the bottom for an example of using this class.
...
class Client
   ...
   attr_reader :num_fields, :numMatches, :num_records, :num_recs_added, :num_recs_deleted
   attr_reader :num_recs_input, :num_recs_updated, :numadded
   attr_reader :numRecords, :numremoved, :oldestancestorappid, :options, :org, :page, :pagebody
   ...
   attr_reader :responseXMLdoc, :rid, :rids, :role, :roleid, :rolename, :saveviews, :screenName 
   ...
   attr_writer :printRequestsAndResponses, :qbhost, :stopOnError, :udata, :rdr, :xsl, :encoding
...
#-----------------------------------------------------------------------------------
# To test the QuickBase::Client, copy the #require 'QuickBaseClient'
# and '#testQuickBaseClient' lines below into testQBC.rb, uncomment the
# lines, supply a valid username, password, and database name as parameters,
# and run 'ruby testQBC.rb' .
#-----------------------------------------------------------------------------------
#require 'QuickBaseClient'
#testQuickBaseClient( "username", "password", "database name" )
